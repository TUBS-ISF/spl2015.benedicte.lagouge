...
public class GameRenderer {
	...
	public void setParameters(String l,String s,String ss) {
		this.lifebar = l;
		this.score = s;
		this.sounds = ss;
	}
	...
	public void draw(Graphics2D g, TileMap mainMap, TileMap backgroundMap, TileMap foregroundMap, int screenWidth, int screenHeight) {
		...
		/*part of scoring*/ //TODO
		if(this.score.equals("yes")) {
			int score = player.getScore();
			g.drawString("Score :" + score, 300, 17);
		}
		/*part of lifebar*/ //TODO
		if(this.lifebar.equals("yes")) {
