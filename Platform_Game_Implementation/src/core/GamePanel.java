...
import objects.mario.Mario;

import core.animation.SpriteListener;
import core.sound.MidiPlayer;
...
public class GamePanel extends JPanel implements Runnable {
	...
	public GamePanel(int w, int h,String l, String s,String ss) {
		this.panelWidth = w;
		this.panelHeight = h;

		SM_22050_Hz = new MarioSoundManager22050Hz(new AudioFormat(22050, 8, 1, true, true));
		mario = new Mario(SM_22050_Hz,ss);

		try {
			manager = new GameLoader(ss);
			renderer = new GameRenderer();
			renderer.setParameters(l,s,ss);
